...
//判断分数
    ...
    if(this.score <= 10){
        ...
        if(this.score >=20 && this.score <= 25){
           $('.layer_header').html('custom/images/layer_header01.png');
           $('.layer-btn').find('a').eq(1).attr('href','exclusive_ Photo.html?type=1')
        //皇贵妃   
        }else if(this.score >=25 && this.score <= 30){
           $('.layer_header').html('custom/images/layer_header02.png');
           $('.layer-btn').find('a').eq(1).attr('href','exclusive_ Photo.html?type=2')
        }
        $("#open").trigger('click');
    }
};
